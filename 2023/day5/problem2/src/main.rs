...
fn main() {
    ...
    for s in 0..seeds.len()/2 {
        let start_seed_num:u64 = seeds[s*2].parse().unwrap();
        let seed_count:u64 = seeds[s*2+1].parse().unwrap();
        for seed_num in start_seed_num..(start_seed_num + seed_count) {
    ...
    //        println!("{} {} {} {} {} {} {} {}", seed_num, soil, fert, water, light, temp, humid, location);
        ...
        println!("Done with seed {}    Min is {}", start_seed_num, min_location);
    }
